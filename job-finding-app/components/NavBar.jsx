...
export default function NavBar() {
    ...
    return (
        <>
            <div className={`w-full ${scrolled ? "bg-blue-100" : "bg-blue-600"} px-2 h-20 bg-blue-500 text-white flex items-center justify-between fixed top-0 left-0 z-50`}>
                <div className='px-2 h-full flex items-center justify-center space-x-2'>
                    <div className=''>
                ...
                <div className='px-2 h-full hidden items-center justify-center lg:flex ' >
                    {
                        user !== null ? (
                            <>
                                ...
                                <BiLogOut onClick={handleLogout} className=' cursor-pointer text-3xl hover:text-red-500 transition-all duration-700 px-0.5' />
                                <Image width={50} height={50} className="flex rounded-full mb-4 md:mb-0 px-0.5" src={"https://xsgames.co/randomusers/avatar.php?g=male"} alt="no-image-found" />
                                <p className='text-lg px-0 font-semibold'>{user?.name}</p>
